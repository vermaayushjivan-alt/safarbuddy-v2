...
import {
  getDestinationImagesAdmin,
  uploadDestinationImageAdmin,
  setPrimaryDestinationImageAdmin,
  reorderDestinationImageAdmin,
  deleteDestinationImageAdmin,
  type DestinationImageWithUrl,
...
export function DestinationImageManager({ destinationId }: DestinationImageManagerProps) {
  const [images, setImages] = useState<DestinationImageWithUrl[]>([]);
