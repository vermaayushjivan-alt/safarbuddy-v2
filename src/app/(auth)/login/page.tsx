  ...
  return (
    ...
    >
      <div className="space-y-5" aria-hidden="true">
        <div className="h-[68px] animate-pulse rounded-xl bg-[var(--color-mist)]" />
        <div className="h-[68px] animate-pulse rounded-xl bg-[var(--color-mist)]" />
        <div className="h-10 animate-pulse rounded-xl bg-[var(--color-mist)]" />
      </div>
    </AuthLayout>
  );
}
  ...
  return (
    ...
    >
      <form action={formAction} className="space-y-5" noValidate>
        ...
        <label className="flex select-none items-center gap-2 text-sm text-[var(--color-ink)]/60">
          <input
            type="checkbox"
            name="rememberMe"
            className="h-4 w-4 rounded border-[var(--color-mist)] text-[var(--color-sky)] focus:ring-[var(--color-sky)]/30"
          />
          Remember me
        </label>
      ...
      <form action={googleLoginAction}>
        ...
        <button
          type="submit"
          className="flex w-full items-center justify-center gap-2 rounded-xl border border-[var(--color-mist)] py-2.5 text-sm font-medium text-[var(--color-ink)] transition hover:bg-[var(--color-mist-2)]"
        >
          <GoogleIcon />
